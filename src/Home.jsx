      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute bottom-48 w-full px-6 sm:px-11 flex flex-col sm:flex-row justify-around">
          <div className="w-full sm:w-[48%] p-6 gap-10 rounded-lg shadow-lg mb-4 sm:mb-0">
            ...
            <button
              className="absolute text-lg px-24 py-4 z-[2] font-semibold mt-4 bg-white rounded-full cursor-pointer"
        ...
        <h1 className="font-semibold px-12  mt-24  absolute font-jakarta text-4xl sm:text-2xl md:text-3xl lg:text-4xl w-auto">
          Blog
        </h1>
        <Allblog />
        <Google />
